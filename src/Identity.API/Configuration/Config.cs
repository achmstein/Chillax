namespace Chillax.Identity.API.Configuration
{
    public class Config
    {
        ...
        public static IEnumerable<ApiResource> GetApis()
        {
            return new List<ApiResource>
            {
                ...
                new ApiResource("rooms", "Rooms Service"),
        ...
        public static IEnumerable<ApiScope> GetApiScopes()
        {
            return new List<ApiScope>
            {
                ...
                new ApiScope("rooms", "Rooms Service"),
        ...
        public static IEnumerable<Client> GetClients(IConfiguration configuration)
        {
            return new List<Client>
            {
                ...
                new Client
                {
                    ClientId = "chillax-mobile",
                    ClientName = "Chillax Mobile App",
                    AllowedGrantTypes = GrantTypes.Code,
                    RequirePkce = true,
                    RequireClientSecret = false,
                    RedirectUris = { "com.chillax.app://callback" },
                    PostLogoutRedirectUris = { "com.chillax.app://" },
                    RequireConsent = false,
                    AllowOfflineAccess = true,
                    AlwaysIncludeUserClaimsInIdToken = true,
                    AllowedScopes = new List<string>
                ...
                // Chillax Admin Panel (React)
                new Client
                {
                    ClientId = "chillax-admin",
                    ClientName = "Chillax Admin Panel",
                    AllowedGrantTypes = GrantTypes.Code,
                    RequirePkce = true,
                    RequireClientSecret = false,
                    AllowAccessTokensViaBrowser = true,
                    RedirectUris = new List<string>
                    {
                        $"{configuration["AdminPanelClient"]}/auth/callback",
                        "http://localhost:5173/auth/callback"
                    },
                    PostLogoutRedirectUris = new List<string>
                    {
                        $"{configuration["AdminPanelClient"]}",
                        "http://localhost:5173"
                    },
