...
namespace Rooms.Infrastructure.Migrations
{
    ...
    [Migration("20260120192331_AddSessionMembersAndAccessCode")]
    partial class AddSessionMembersAndAccessCode
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.HasSequence("reservationseq", "rooms")
                .IncrementsBy(10);

            modelBuilder.HasSequence("roomseq", "rooms")
                .IncrementsBy(10);
            ...
            modelBuilder.Entity("Chillax.IntegrationEventLogEF.IntegrationEventLogEntry", b =>
                {
                    ...
                    b.ToTable("IntegrationEventLog", "rooms");
                });
            ...
            modelBuilder.Entity("Chillax.Rooms.Domain.AggregatesModel.ReservationAggregate.SessionMember", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseHiLo(b.Property<int>("Id"), "sessionmemberseq", "rooms");
            ...
            modelBuilder.Entity("Chillax.Rooms.Infrastructure.Idempotency.ClientRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("requests", "rooms");
                });

            modelBuilder.Entity("Chillax.Rooms.Domain.AggregatesModel.ReservationAggregate.Reservation", b =>
                {
                    b.HasOne("Chillax.Rooms.Domain.AggregatesModel.RoomAggregate.Room", "Room")
                        .WithMany()
